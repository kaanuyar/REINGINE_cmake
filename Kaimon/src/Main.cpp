...
int main()
{
	...
	EntityShaderProgram entityShaderProgram("../Kaimon/src/shaders/VertexShader.vert", "../Kaimon/src/shaders/FragmentShader.frag");
	...
	RawEntity rawEntity = OBJLoader::loadFile("../Kaimon/res/models/wallCube2.obj");
	RawEntity rawEntity2 = OBJLoader::loadFile("../Kaimon/res/models/tree.obj");
	RawEntity rawTerrain = Terrain::createTerrain(20, 20);
	Texture texture1("../Kaimon/res/textures/checker128.png", 0);
	Texture texture2("../Kaimon/res/textures/wall.jpg", 1);
